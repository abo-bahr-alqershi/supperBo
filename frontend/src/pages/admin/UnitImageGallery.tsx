/**
 * صفحة إدارة معرض صور الوحدات - صفحة شاملة لإدارة صور الوحدات
 * Unit Image Gallery Management Page - Comprehensive unit images management page
 */
 ...
 * Unit Image Gallery Management Page
 */
const UnitImageGallery: React.FC = () => {
  ...
  const unitLoading = false;
  const unitError = null;
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            <div className="flex items-center gap-2 text-sm text-gray-500 mb-2">
              ...
              <span>/</span>
              <button
                onClick={() => navigate(`/admin/units?propertyId=${propertyId}`)}
                className="hover:text-blue-600 transition-colors"
              >
                الوحدات
              </button>
            ...
            <h1 className="text-2xl font-bold text-gray-900">معرض صور الوحدة</h1>
      ...
      <div className="bg-white rounded-lg shadow-sm border">
        ...
        <div className="p-6">
          ...
          {activeTab === 'upload' && (
            <div className="space-y-6">
              <div>
                <h3 className="text-lg font-semibold mb-2">رفع صور جديدة للوحدة</h3>
                <p className="text-gray-600">
                  اختر الصور لرفعها وربطها بهذه الوحدة. يمكنك تحديد فئة كل صورة والتحكم في ترتيبها.
                </p>
              </div>
          ...
          {activeTab === 'statistics' && (
            <div className="space-y-6">
              <div>
                <h3 className="text-lg font-semibold mb-2">إحصائيات صور الوحدة</h3>
                <p className="text-gray-600">
                  نظرة عامة على صور هذه الوحدة والمساحة المستخدمة.
                </p>
              </div>
