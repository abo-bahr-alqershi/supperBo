...
public class NotificationConfiguration : IEntityTypeConfiguration<Notification>
{
    ...
    public void Configure(EntityTypeBuilder<Notification> builder)
    {
        ...
        builder.Property(n => n.CreatedAt).HasColumnType("datetime").IsRequired();
        builder.Property(n => n.UpdatedAt).HasColumnType("datetime").IsRequired();
        builder.Property(n => n.IsActive).HasDefaultValue(true);
        builder.Property(n => n.IsDeleted).HasDefaultValue(false);
        builder.Property(n => n.DeletedAt).HasColumnType("datetime");
        ...
        builder.Property(n => n.ReadAt).HasColumnType("datetime");
        builder.Property(n => n.DismissedAt).HasColumnType("datetime");
        builder.Property(n => n.ScheduledFor).HasColumnType("datetime");
        builder.Property(n => n.ExpiresAt).HasColumnType("datetime");
        builder.Property(n => n.DeliveredAt).HasColumnType("datetime");
