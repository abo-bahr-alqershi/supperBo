...
public class ImageProcessingService : IImageProcessingService
{
    ...
    public async Task<YemenBooking.Core.Interfaces.Services.ImageInfo> GetImageInfoAsync(
        Stream imageStream,
        CancellationToken cancellationToken = default)
    {
        try
    ...
    private static YemenBooking.Core.Interfaces.Services.ImageInfo CreateImageInfo(Image image, long fileSize)
    {
        var format = DetectImageFormat(image);
        
        return new YemenBooking.Core.Interfaces.Services.ImageInfo
        {
            Width = image.Width,
            Height = image.Height,
            Format = format,
