...
namespace YemenBooking.Infrastructure.Services
{
    ...
    public class SearchService : ISearchService
    {
        ...
        public Task<(IEnumerable<Property> Properties, int TotalCount)> AdvancedSearchAsync(
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            return _propertyRepository.GetPropertiesByOwnerAsync(Guid.Empty, cancellationToken)
                .ContinueWith(t => ((IEnumerable<Property>)t.Result, t.Result.Count()), cancellationToken);
        }
