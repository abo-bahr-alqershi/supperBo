...
public interface INotificationService
{
    ...
    /// </summary>
    Task SendCheckInNotificationAsync(Booking booking, CancellationToken cancellationToken = default);
    
    /// <summary>
    /// إرسال إشعار تسجيل المغادرة
    /// Send check-out notification
    /// </summary>
    Task SendCheckOutNotificationAsync(Booking booking, CancellationToken cancellationToken = default);
    
    /// <summary>
    /// إرسال إشعار إلغاء الحجز
    /// Send booking cancellation notification
    /// </summary>
    Task SendBookingCancellationAsync(Booking booking, string reason, CancellationToken cancellationToken = default);
    
    /// <summary>
    /// إرسال إشعار تذكير بالحجز
    /// Send booking reminder notification
    /// </summary>
    Task SendBookingReminderAsync(Booking booking, int daysBefore, CancellationToken cancellationToken = default);
    
    /// <summary>
    /// إرسال إشعار دفع
    /// Send payment notification
    /// </summary>
    Task SendPaymentNotificationAsync(Booking booking, decimal amount, PaymentStatus status, CancellationToken cancellationToken = default);
