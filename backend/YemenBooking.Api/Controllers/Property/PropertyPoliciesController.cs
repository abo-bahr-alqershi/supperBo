...
{
    /// <summary>
    /// متحكم بسياسات الكيانات لأصحاب الكيانات
    /// Controller for managing property policies by property owners
    /// </summary>
    public class PropertyPoliciesController : BasePropertyController
    {
