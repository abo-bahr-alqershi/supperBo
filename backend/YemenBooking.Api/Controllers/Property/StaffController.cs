...
{
    /// <summary>
    /// متحكم بعمليات الموظفين لأصحاب الكيانات: إضافة، تعديل، إزالة واستعلام
    /// Controller for staff management by property owners
    /// </summary>
    public class StaffController : BasePropertyController
    {
