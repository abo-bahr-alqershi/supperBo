...
import 'package:yemen_booking_app/features/chat/data/models/message_reaction_model.dart';
...
class ChatWebSocketService {
  ...
  Future<void> connect() async {
    ...
    try {
      ...
      // Build WebSocket URL - matching backend SignalR hub
      final wsUrl = '${ApiConstants.baseUrl.replaceFirst('http', 'ws')}/chathub?access_token=$token';
