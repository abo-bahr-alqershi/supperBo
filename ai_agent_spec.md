انت وكيل الذكاء الاصطناعي الخاص بي المسؤول عن تصحيح وتطوير الية ادارة الصفحة الرئيسية في تطبيق الموبايل
واهم مايهمني هو التوافق التام مع الباك اند وايضا مع مايتوقعه ويحتاجه مشروع تطبيق الموبايل
ولاتقم بكتابة اي اكواد في حال كانت تتطلب منك قراءة بعض الملفات لضمان التوافق
ويمكنك طلب اي ملفات مني وسأزودك بها فورا
ويمكنك انشاء اي شيء تريده في ايا من مشاريعي الثلاثة
ولاكن يجب ضمان التوافق وطلب قراءة اي ملفات تريدها 
علما ان مشروعي للحجوزات هو backend: asp.net core + cqrs 
frontend: react typescript + vite
mobile app : flutter + bloc


وسأقوم الان بتزويدك بما يخص توقعات تطبيق الموبايل
ثم بما يخص الفرونت اند 
لتقوم بالتصحيح
هذا مايخص تطبيق الموبايل


وسأبدأ بالمخطط ثم بالملفات مباشرة
lib/
├── main.dart
├── app.dart
